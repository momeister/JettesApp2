...
public class CourseModal {
    ...
    */
    ...
    public CourseModal(int Text, String bla){


        if(Text == -1){
            this.courseName = "Willkommen bei Jettes Spiel: \nUm zu beginnen, einfach swipen ;)";
        }else{
            //this.courseName = String.valueOf(RandomNumber);
            this.courseName = bla;
            this.courseDuration = "";
            this.courseTracks = "";
